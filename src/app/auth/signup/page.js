...
import { Eye, EyeOff, User, Mail, Lock, Anchor } from 'lucide-react';

export default function FinanceTrackerSignUp() {
      ...
      <div className="flex flex-col min-h-screen">
        ...
        <div className="flex-1 px-4">
          <div className="bg-white rounded-3xl shadow-xl p-8 mx-auto max-w-md relative overflow-hidden">
            ...
            <h2 className="text-2xl font-bold text-gray-800 mb-6 text-center relative z-10" style={{fontFamily: 'Poppins, sans-serif'}}>Create An Account</h2>
